...
import { CatExperiencesDialogPage } from './cat-experiences-dialog.page';
...
import { CatExperiences } from '../../../models/catalogos/cat-experiences.model';
import { ICatExperiences } from 'app/models/catalogos/cat-experiences.model';

@Component({
    selector: "app-cat-experiences-list",
    templateUrl: "./cat-experiences-list.page.html",
...
export class CatalogsListPage implements OnInit {
    ...
    constructor(
        ...
        private valueService: CatExperiencesService
    ) {
    ...
    newItem(): void {
        ...
        const dialogRef = this.dialog.open(CatExperiencesDialogPage, { data: params });
    ...
    view(value: CatAdventures): void {
        ...
        const dialogRef = this.dialog.open(CatExperiencesDialogPage,  this.dialogConf );
        dialogRef.updateSize('50%');
        dialogRef.afterClosed().subscribe((src: any) => {
